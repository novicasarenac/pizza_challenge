...
pizzaChallenge.controller('PizzaController', ['$scope', 'PizzaService', function($scope, PizzaService) {
  var pizzas = {};
  const meats = ['meat', 'ham', 'sausages', 'salami', 'beef', 'kebab'];
  //groups[0] = pizzas mith meat; groups[1] = pizzas with cheese; groups[2] = pizzas with meat and olives; groups[3] = pizzas with mozzarela and mushrooms
  var groups = []
  for(i = 0; i < 4; i++) {
    groups[i] = {
      pizzas: [],
